...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *deconnexion = [[UIBarButtonItem alloc] initWithTitle:@"Déconnexion" style:UIBarButtonItemStyleBordered target:self action:@selector(deconnexion:)];
    [self.navigationItem setRightBarButtonItem:deconnexion];
